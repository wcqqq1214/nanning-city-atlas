...
| 功能 | 可以做什么 |
| --- | --- |
| **地标探索** | 点击列表或地图标记，查看 23 个地点；其中 18 个独立模型可进入近景。 |
...
可以查看相思湖、三街两巷、南湖、青秀山、国际会展中心、南宁大桥、广西文化艺术中心、两座铁路车站与中华路高架等。完整名单见 [地标目录](data/landmarks.json)。清厢快速路先完成站前约 1.93 km 主线与四条相邻匝道，范围和近似说明见 [高架首段建模](docs/VIADUCT.md)。
...
- [模型资源](public/models/)：约 8.64 MB 的精细模型与 6.10 MB 的轻量模型。
