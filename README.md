...
| 功能 | 可以做什么 |
| --- | --- |
| **地标探索** | 点击列表或地图标记，查看 35 个地点；建筑等地标提供近景，高架按整体路段展示。 |
...
可以查看相思湖、三街两巷、南湖、青秀山、国际会展中心、南宁大桥、广西文化艺术中心、两座铁路车站与清厢快速路高架等。已细化 13 座主要跨江桥梁，包含青山、五象、英华、良庆、永和等桥的塔索与拱肋结构，见 [主要桥梁](docs/BRIDGES.md)。完整名单见 [地标目录](data/landmarks.json)。清厢快速路已覆盖从清川大道至厢竹大道、凤岭北路的全线，按当前地图中心线约 14.25 km，包含 31 个主线连接点和 332 个桥墩，范围和近似说明见 [高架建模](docs/VIADUCT.md)。
...
- [模型资源](public/models/)：约 16.22 MB 的精细模型与 11.69 MB 的轻量模型。
