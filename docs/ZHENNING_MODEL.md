...
本页记录 2026-09-10 的历史实现。2026-09-12 P4 已在正式生成器中移除 2.4×/1.55× 独立放大，改用来源尺寸、实际场地避让与局部树冠比例；最新参数和验收状态见[地标比例与场地校准](URBAN_STRUCTURE_LANDMARKS.md)。下文旧倍率、清理范围和当时的资源增量保留作历史记录。
