...
b=Path('work/urban-structure/p5/full-city-review');source=b/'forest-candidate-clean.json';output=b/'forest-candidate-conforming-v2.json'
assert not output.exists()
plan=json.loads(source.read_text());report={}
for region in plan['regions']:
 if region['id']!='nearby':continue
 for profile in ['detail','smooth']:
  old=region[profile]
  new,r=conform_edges(old,box(54.9,-7.8,56,-6.8))
  ...
  region[profile]=new;report[profile]=r;print(profile,r,flush=True)
