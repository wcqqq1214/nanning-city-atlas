...
> 本页为三处文化地标首次交付的历史记录。龙象塔的原展示倍率、文件预算和当时的道路检查结果不代表当前版本；已完成的来源尺寸校准及青秀山场地重建见 [P3 青秀山样板](URBAN_STRUCTURE_QINGXIU.md)，当前总体进度见[城市结构计划](URBAN_STRUCTURE_PLAN.md)。两座博物馆不在 P3 修改范围内。
